...
const EditWebPassword = ({ user, editPassword, setEditPassword, editMenu, toggleEditMenu, setData }) => {
    ...
    const handleClick = async (e) => {
        ...
        const res = await axios.patch(
            `${process.env.REACT_APP_API}/webs/${editPassword._id}/${user._id}`, {
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex flex-wrap">
                                <input disabled={disabledInput}
                                    ...
                                    type="text" name="url" placeholder="https://www.webflow.com" id="editURL" value={editPassword.url} onChange={handleChange} />
                                <div className="flex w-1/6 pl-2 mb-2">
                                    <a className="flex w-full justify-center items-center bg-gray-50 dark:bg-gray-900 dark:border dark:border-white rounded" href={editPassword.url} alt="" target="_blank" rel="noopener noreferrer">
                                        <svg className="w-6 h-6" fill="none" stroke={(colorTheme === 'dark') ? '#fff' : '#382CDD'} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                                    </a>
                                </div>
                            </div>
                        </div>
...
export default EditWebPassword