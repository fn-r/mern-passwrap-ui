...
import WebPasswordList from "../components/web/WebPasswordList";
import AddWebPassword from "../components/web/AddWebPassword";
import EditWebPassword from "../components/web/EditWebPassword";
...
const Webs = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API}/webs/${user._id}`)
                        ...
                        <div className="px-6 pb-6 pt-4 bg-white dark:bg-gray-800 shadow rounded">
                            <div className="flex flex-wrap items-center mb-3">
                                <div className="flex items-center">
                                    <h3 className="mr-2 text-xl font-bold dark:text-white">Webs Vault</h3>
                                </div>
